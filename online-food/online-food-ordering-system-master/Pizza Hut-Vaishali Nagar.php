...
$sql1="SELECT * FROM `Pizza Hut-Vaishali Nagar` WHERE 1";
if (!mysql_query($sql,$con))
  {
  die('Error: ' . mysql_error());
  }
...
?>		<form  method = "post">
		...
		<td rowspan = 3 class = "img1"><img src = "images/<?php echo("$i_name")?>.png" width="120" height = "120"></td>
