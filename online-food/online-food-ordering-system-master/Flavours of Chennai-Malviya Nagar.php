<!DOCTYPE html>
<html lang="en">
<title>Flavors of Chennai</title>
<head>
...
?>
	 ...
	 <header>
       ...
       <div class="bg2">
			...
			<img src = "images/Flavours of Chennai.png">			
			</div>
...
$sql1="SELECT * FROM `flavours of chennai - malviya nagar` WHERE 1";
if (!mysql_query($sql,$con))
  {
  die('Error: ' . mysql_error());
  }
...
?>		<form  method = "post">
		...
		<td class="price1">Regular
		
		<td class="price2"><p><?php echo "$price"?></p></td>
		<input type="hidden" name="ip" value="<?PHP echo("$price") ?>">
